...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
	<Card class="w-full max-w-md p-8">
		<div class="mb-8 text-center">
			<h1 class="text-3xl font-bold text-gray-900">Loafy Club</h1>
			<p class="mt-2 text-sm text-gray-600">Sign in to book your pickleball sessions</p>
		</div>

		{#if error}
			<div class="mb-6 rounded-md bg-destructive/10 p-4">
